...
class StudentProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_profile" do
    assert_difference('StudentProfile.count') do
      post student_profiles_url, params: { student_profile: { fos: @student_profile.fos, name: @student_profile.name, phoneNo: @student_profile.phoneNo, studentID: @student_profile.studentID } }
    end
  ...
  test "should update student_profile" do
    patch student_profile_url(@student_profile), params: { student_profile: { fos: @student_profile.fos, name: @student_profile.name, phoneNo: @student_profile.phoneNo, studentID: @student_profile.studentID } }
